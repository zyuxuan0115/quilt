...
function build_rust_test {
    ...
    sudo docker build -t zyuxuan0115/mm-compose-review-upload-user-id-async:latest \
        -f Dockerfile \
...
function push_rust_test {
    sudo docker push zyuxuan0115/mm-compose-review-upload-user-id-async:latest
}
