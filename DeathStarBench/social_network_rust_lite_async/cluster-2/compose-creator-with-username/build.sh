...
function build_rust_test {
    ...
    sudo docker build --no-cache -t zyuxuan0115/sn-compose-creator-with-username-async:latest \
        -f Dockerfile \
...
function push_rust_test {
    sudo docker push zyuxuan0115/sn-compose-creator-with-username-async:latest
}
