...
$CC -fPIC -emit-llvm -S $CPPFLAGS main.c -c -o main.ll
...
$OPT -load $SOFTBOUND_INIT_LIB -InitializeSoftBoundCETS main.ll -S -o main_1.ll
$OPT -load $SOFTBOUND_LIB -SoftBoundCETSPass main_1.ll -S -o main_softbound.ll



$LLC -filetype=obj main_softbound.ll -o main.o
