...
#ifndef LLVM_TRANSFORMS_UTILS_MERGESWIFTFUNC_H
#define LLVM_TRANSFORMS_UTILS_MERGESWIFTFUNC_H
...
class MergeSwiftFuncPass : public PassInfoMixin<MergeSwiftFuncPass> {
public:
...
#endif // LLVM_TRANSFORMS_UTILS_MERGESWIFTFUNC_H
